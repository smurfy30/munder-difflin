...
import { readLanes, createLanesDraft } from './lanes';
...
ipcMain.handle('lanes:snapshot', () => readLanes());
ipcMain.handle('lanes:createDraft', (_event, input) => createLanesDraft(input));
